...
const ALLOWED_ORIGINS = ['https://www.easyedit.com', 'https://easyedit.com'];
  ...
  try {
    ...
    if (!response) {
      response = await fetch(targetUrl, {
        headers: {
          'User-Agent': 'Easyedit-WASM-Proxy/1.0',
          Accept: '*/*',
        },
      });
