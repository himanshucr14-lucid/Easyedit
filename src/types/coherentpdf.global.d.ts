/*
 * coherentpdf.global.d.ts — TypeScript type definitions for Easyedit / CoherentPDF integration
 *
 * These type definitions were written by Alam for use in the Easyedit project.
