...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/easyedit/easyedit)

## Manual Deployment

### Step 1: Fork the Repository

Fork [easyedit/easyedit](https://github.com/easyedit/easyedit) to your GitHub account.
...
| `VITE_BRAND_NAME`       | Custom brand name (replaces "Easyedit")                     |
...
::: warning Large Files
Vercel's serverless functions have a 50MB limit. Since Easyedit is a static site, this shouldn't affect you, but WASM modules are large (~100MB total). Ensure they're served from the `/public` folder.
:::
