...
Host Easyedit using Apache HTTP Server.
...
```bash
sudo mkdir -p /var/www/easyedit
sudo cp -r dist/* /var/www/easyedit/
sudo chown -R www-data:www-data /var/www/easyedit
```

## Step 3: Apache Configuration

Create `/etc/apache2/sites-available/easyedit.conf`:
...
<VirtualHost *:443>
    ServerName your-domain.com
    DocumentRoot /var/www/easyedit

    SSLEngine on
    SSLCertificateFile /etc/letsencrypt/live/your-domain.com/fullchain.pem
    SSLCertificateKeyFile /etc/letsencrypt/live/your-domain.com/privkey.pem

    <Directory /var/www/easyedit>
...
Create `/var/www/easyedit/.htaccess`:
...
```bash
sudo chown -R www-data:www-data /var/www/easyedit
sudo chmod -R 755 /var/www/easyedit
```
