...
Welcome to Easyedit! This guide will help you get up and running quickly.

## What is Easyedit?

Easyedit is a free, open-source, privacy-first PDF toolkit that runs **entirely in your browser**. Your files never leave your device—all processing happens locally using WebAssembly (WASM) technology.

## Quick Start

### Option 1: Use the Hosted Version

Visit [easyedit.com](https://easyedit.com) to use Easyedit instantly—no installation required.
...
curl -O https://raw.githubusercontent.com/easyedit/easyedit/main/docker-compose.yml
docker compose up -d
```
...
Easyedit works best on modern browsers:
...
- [Self-host Easyedit](/self-hosting/)
