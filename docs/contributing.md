...
Thank you for your interest in contributing to Easyedit! This guide will help you get started.
...
git clone https://github.com/YOUR_USERNAME/easyedit.git
cd easyedit
...
See [TRANSLATION.md](https://github.com/easyedit/easyedit/blob/main/TRANSLATION.md) for adding new languages.

## Contributor License Agreement

Before your PR can be merged, you'll need to sign our CLA:

- [Individual CLA (ICLA)](https://github.com/easyedit/easyedit/blob/main/ICLA.md)
- [Corporate CLA (CCLA)](https://github.com/easyedit/easyedit/blob/main/CCLA.md)

## Getting Help

- [GitHub Issues](https://github.com/easyedit/easyedit/issues)
- [Discord Community](https://easyedit.com)

## License

Easyedit is dual-licensed:
